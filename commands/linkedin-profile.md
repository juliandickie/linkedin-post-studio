...
- **`edit $2`** — Ask the user: "Which section? (identity | audience | voice | compliance | operations)". Then open the profile file for direct editing OR resume `onboarding/create-profile.md` at the relevant step for guided edits.
